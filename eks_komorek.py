...
class MainMenuScene(QGraphicsScene):
    ...
    def create_menu(self):
        ...
        level_button = HoverableRectItem(250, 350, 400, 100)                     
        level_button.setBrush(QBrush(QColor(10, 10, 50)))
        level_button.setPen(QPen(Qt.white, 2))
        self.addItem(level_button)
        ...
        exit_button = HoverableRectItem(250, 500, 400, 100)                     
...
class GameView(QGraphicsView):
    def __init__(self):
        ...
        network_signal_handler.update_cells.connect(self.handle_network_cell_update)                 
